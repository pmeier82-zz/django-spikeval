    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('algorithm', models.ForeignKey(default=1, to='djspikeval.Algorithm', help_text=b'The Algorithm associated with this Batch.')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(default=2, to=settings.AUTH_USER_MODEL, help_text=b'The user who contributed this Benchmark.')),
        ...
        migrations.AddField(
            model_name='batch',
            name='benchmark',
            field=models.ForeignKey(help_text=b'The Benchmark associated with this Batch.', to='djspikeval.Benchmark'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='batch',
            name='owner',
            field=models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, help_text=b'The user associated with this Batch.'),
            preserve_default=True,
        ),
